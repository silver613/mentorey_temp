      ...
      <Box>
        <Container className="py-8 lg:pb-4 lg:pt-12">
          ...
          <div className="block md:flex">
            <div className="mx-auto my-2 flex max-w-sm flex-1 px-2">
              <div className="w-1/4">
                <Image
                  src={findCoachImage}
                  width={80}
              ...
              <div className="w-3/4">
                ...
                >
                  Watch coach introduction videos and read reviews from the
                  others.
                </Typography>
              </div>
            </div>
            ...
            <div className="mx-auto my-2 flex max-w-sm flex-1 px-2">
              ...
              <div className="w-3/4">
                ...
                <Typography
                  ...
                  className="font-semibold text-slate-600"
                >
                  Connect with your teacher via a video call, and start
                  learning!
                </Typography>
              </div>
            </div>
